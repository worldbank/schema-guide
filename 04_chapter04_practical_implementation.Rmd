...
The metadata elements listed in a standard have the following properties:
...
Some schemas may recommend controlled vocabularies for some elements. But in most cases, controlled vocabularies are not part of the metadata standard itself as they may be specific to an organization. They may be provided and activated in templates in the Metadata Editor.
...example...
