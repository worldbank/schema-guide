...
This guide is designed to promote and facilitate the creation and utilization of comprehensive and structured metadata, thereby encouraging the responsible use and repurposing of data. The primary audience for this guide includes data producers and curators, data librarians, catalog administrators, and developers of data management and dissemination platforms. These stakeholders aim to maximize the value of existing data in a responsible and technically proficient manner by adopting metadata standards and implementing best practices for data documentation and cataloging. The guide is particularly applicable to various types of socio-economic data, including indicators, microdata, geographic datasets, publications, and more.
