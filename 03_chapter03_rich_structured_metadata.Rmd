...
Detailed and complete metadata foster usability and discoverability of data. Augmentation of "enrichment" or "enhancement" of the metadata --which can apply to any metadata standard-- will therefore be beneficial. There are multiple ways metadata can be programmatically **enhanced** or **augmented**, in a largely automated manner. Metadata can be extracted from external sources or from the data themselves. 
