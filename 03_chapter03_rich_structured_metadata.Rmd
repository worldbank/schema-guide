...
This chapter describes what metadata are needed, and how they can be organized and improved to enable modern search and recommender solutions. The metadata must be **rich** and **structured**. In this chapter, we build the case for rich, augmented, structured metadata and for the adoption of metadata standard and schemas. 
