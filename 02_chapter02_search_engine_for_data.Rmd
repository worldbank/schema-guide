...
Users of a data catalog will typically want to **search** and **filter** the assets available in a catalog. They will also want to **browse** and **sort** the catalog or the entries returned by the activation of a search or filter. We describe below how the search, filtering, sorting, and browsing features may be designed to provide a user-friendly experience. **Other features** of a data catalog that may be useful to users are also proposed.
