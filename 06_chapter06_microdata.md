...
The `embeddings` element contains four metadata fields:
  ...
  A unique identifier of the word embedding model used to generate the vector.<br>
  - **`description`** *[Optional ; Not repeatable ; String]* <br>
  A brief description of the model. This may include the identification of the producer, a description of the corpus on which the model was trained, the identification of the software and algorithm used to train the model, the size of the vector, etc.<br>
  - **`date`** *[Optional ; Not repeatable ; String]* <br>
  The date the model was trained (or a version date for the model).<br>
  - **`vector`** *[Required ; Not repeatable ; Object]* @@@@@@@@ do not offer options<br>
