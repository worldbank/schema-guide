...
Numerous organizations are actively engaged in data sharing, with many embracing open access data policies. The online landscape is now rich with a vast and diverse array of data, readily available to researchers and data analysts. However, a significant obstacle confronts these individuals: the practicality of locating, accessing, and utilizing this wealth of data. Navigating through an expansive and continually growing pool of data sources and types poses a multifaceted challenge that demands time, effort, and occasionally leads to frustration. This challenge involves the identification of pertinent sources, the acquisition and comprehension of relevant datasets, and the effective analysis thereof. Issues contributing to this complexity include inadequate metadata, limitations in data discovery algorithms and systems, and the restricted visibility of valuable data repositories and cataloging systems. Overcoming the technical hurdles related to data discoverability, accessibility, and usability is essential for enhancing the efficacy of data sharing policies and optimizing the utility of collected data. The subsequent sections will delve into these challenges in greater detail.

## Finding data

Researchers and data users employ various methods to identify and acquire data. Some rely on personal networks to locate and obtain the data they require, or identify datasets of interest in academic publications. This may lead to the use of data that may not be the most relevant for the researcher's specific purpose. Many other data users rely on general search engines or turn to specialized data catalogs to discover relevant data resources.

Prominent internet search engines possess notable capabilities in locating and ranking pertinent resources available online. The algorithms powering these search engines incorporate lexical and semantic capabilities. Straightforward data queries --for example a search for *2023 population of India -- will yield an instant answer to the prompt (though not always from the most authoritative source). Less specific queries --for example a search for *malnutrition in Yemen* -- will not return a direct answer, but will provide adequate information and links to useful resources, as the search engine has semantic capability and can associate anthropometric indicators like *percentage of stunting, wasting, and underweight population* to the concept of malnutrition. Generative artificial intelligence has added the capability of these search engines to engage with data users using natural language, which may be suitable for addressing simple queries, although not without risk of errors and inaccuracies. But internet search engines are not be optimized to identify the most relevant data when the user's requirements cannot be expressed in the form of a straightforward query.  

Specialized online data catalogs or data libraries managed by national or international organizations, academic data centers, and data archives may be better suited for researchers seeking data. But the search algorithms integrated into many of these specialized data catalogs are simple keyword-based systems, and many rely on sub-optimal metadata. They have lexical search capability -- not always adequately optmized -- but most often lack semantic search capability and fail to operate as recommender systems. With the rapid advancements of technology and the availability of powerful open-source solutions, the search performance of specialized data catalogs can be significantly enhanced, transforming data  catalogs into effective data recommender systems. The solution necessitates not only the adoption of better technology, but also high-quality, comprehensive, and structured metadata. Metadata, which offers a detailed description of datasets, is what search engines rely upon to identify and locate data of interest. 
